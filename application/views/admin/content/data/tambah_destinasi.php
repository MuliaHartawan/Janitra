                ...
                <div class="col-md-4 offset-md-4">
                    <form action="<?=site_url('data_destination/process')?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kota" name="kota" value="<?= set_value('kota'); ?>" placeholder="Nama Kota" required>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">Koordinat *</label>
                            <input type="text" class="form-control" id="koordinat" name="koordinat" value="<?= set_value('koordinat'); ?>" placeholder="Koordinat" required>
                        </div>
                        <div class="form-group">
