...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            ...
            <h3 class="card-title">Form Tambah Paket Wisata</h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <form action="<?=site_url('data_paket/process')?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_paket" name="nama_paket" value="<?= set_value('nama_paket'); ?>" placeholder="Nama Paket Wisata" required>
                        </div>
                        <div class="form-group">
